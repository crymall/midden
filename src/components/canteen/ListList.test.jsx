...
describe("ListList", () => {
  ...
  it("renders lists with Favorites first", () => {
    // Pass lists in an order where Favorites is not first to test sorting
  ...
  it("renders links pointing to correct list details", () => {
    renderComponent();
    expect(screen.getByText("View Favorites").closest("a")).toHaveAttribute("href", "/applications/canteen/my-lists/1");
  });
});